...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "io.sariska.sariska_media_java_demo.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "io.sariska.sariska_media_java_demo.app";
    ...
    private static Notification createNotification(@NonNull Context context) {
        ...
        builder.setSmallIcon(R.drawable.baseline_screen_share_24);
